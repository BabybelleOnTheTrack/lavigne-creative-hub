    ...
    <section className="container py-8">
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 max-w-2xl border-2 border-border bg-card p-4 shadow-card">
        <div className="shrink-0">
          <img src={avatarImage} alt="Photo de profil" className="w-16 h-16 border-2 border-border object-cover" />
        </div>
        <div className="text-center sm:text-left">
          <h2 className="font-display text-2xl text-primary mb-1">&gt; Salut !</h2>
