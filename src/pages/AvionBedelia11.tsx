    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <header className="border-b-2 border-border bg-card">
        ...
        <nav className="container py-2 flex gap-4 border-t border-border">
          ...
          <Link to="/avion-bedelia/1-1" className="font-display text-sm text-primary border-b-2 border-primary pb-1">1/1</Link>
        </nav>
      </header>
      ...
      <main className="container py-8 max-w-4xl">
        <section className="mb-12 text-center py-20">
          ...
          <h2 className="font-display text-3xl md:text-4xl mb-6">
            Avion Taille Réelle 1/1
          </h2>
          <p className="font-body text-lg text-muted-foreground">
            En construction...
          </p>
          <p className="font-body text-sm text-muted-foreground mt-4">
            Cette section sera bientôt disponible avec tous les détails de l'avion en taille réelle.
          </p>
        </section>
      </main>
